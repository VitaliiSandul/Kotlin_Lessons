...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button button,
      @NonNull TextInputEditText etA, @NonNull TextInputEditText etB, @NonNull Guideline guideline,
      @NonNull ImageView imageView, @NonNull TextInputLayout textInputLayout2,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.etA;
      TextInputEditText etA = ViewBindings.findChildViewById(rootView, id);
      if (etA == null) {
        break missingId;
      }

      id = R.id.etB;
      TextInputEditText etB = ViewBindings.findChildViewById(rootView, id);
      if (etB == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, button, etA, etB, guideline,
          imageView, textInputLayout2, textInputLayout3, textView, tvResult);
    }
